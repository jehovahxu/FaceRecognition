...
% Database = 'CUFS';
Database = 'CUFSF';
Methods = {'data/xxx/cagan_2/cagan_vggface_sketch/output/700','data/xxx/cagan_2/scagan_vggface_2/output/500'};
refDir = '/data/xxx/photosketch/CUFSF_sketches_944/';

% Database = 'CUFSF';
% Methods = {'cagan_vggface_photo','scagan_vggface_photo'};
% refDir = 'CUFSF_photos_944';
